...
description: |
  In this section, we will be thoroughly investigating and analysing the study area, to select a suitable site  within our study area for the proposed new capital city based on four overarching criteria: **sizable, high accessibility, safety, ease of development**.
output:
